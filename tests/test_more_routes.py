...
All run in open mode with an isolated tmp config + data dir.
"""
import os
import pytest
...
class TestSubscriptionRoutes:
    ...
    def test_subscription_status(self, client):
        ...
        # Open mode: no tenant context → 401
...
class TestTaxMoreRoutes:
    ...
    def test_form_1120s(self, client):
        ...
        # Default config.toml (SMLLC) should return 400 with an entity error
